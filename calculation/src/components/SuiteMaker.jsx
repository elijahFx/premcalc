...
export default function SuitMaker() {
  ...
  function transformDateFormat(inputDate) {
    ...
    const transformedDate = `${dateObj.getDate()}.${
      dateObj.getMonth() + 1 > 9 ? "" : "0"
  ...
  const dict = {
    ...
    "Фрунзенского района г. Минска":
      "220092, г. Минск,  ул. Дунина-Марцинкевича, д. 1, корп. 2",
    "Московского района г. Минска":
      "220083, г. Минск, пр. газеты «Правда», д. 27",
  ...
  return (
    <div className="suitMaker">
      ...
      <div className="boxCreator">
            ...
            <tr>
              ...
              <td>
                ...
                >
                  ...
                  <option value="Заводского района г. Минска">
                    Суд Заводского района г. Минска
                  </option>
                  <option value="Центрального района г. Минска">
                    Суд Центрального района г. Минска
                  </option>
                  <option value="Московского района г. Минска">
                    Суд Московского района г. Минска
                  </option>
                  <option value="Октябрьского района г. Минска">
                    Суд Октябрьского района г. Минска
                  </option>
                  <option value="Ленинского района г. Минска">
                    Суд Ленинского района г. Минска
                  </option>
                  <option value="Партизанского района г. Минска">
                    Суд Партизанского района г. Минска
                  </option>
                  <option value="Первомайского района г. Минска">
                    Суд Первомайского района г. Минска
                  </option>
                  <option value="Советского района г. Минска">
                    Суд Советского района г. Минска
                  </option>
                  <option value="Фрунзенского района г. Минска">
        ...
        <button className="documentCreatorBtn" onClick={handleSubmit}>
          Создать документ
        </button>
      </div>
